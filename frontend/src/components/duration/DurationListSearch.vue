...
import DurationPicker from '../duration/DurationPicker.vue';
import { useI18n } from 'vue-i18n';
import { useAuthStore } from '../../store/auth';
import { Role } from '../../constants/Role';
import EnumPicker from '../common/EnumPicker.vue';
import { DurationListParams, DurationListParamsModel } from '../../models/DurationModel';
...
const searchParams = ref<DurationListParams>(DurationListParamsModel());
...
const onReset = () => {
  searchParams.value = DurationListParamsModel();
  onSearch();
};
...
onMounted(() => {
  const { routeFilter, isFiltered } = useRouteFilter<DurationListParams>(
    searchParams.value,
    route.query
  );
